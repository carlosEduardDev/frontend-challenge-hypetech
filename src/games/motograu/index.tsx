...
import { Message } from './components/message-visible/Message'
      ...
      <div className="flex w-full sm:gap-3 min-h-screen relative">
        <section className="flex flex-col h-full grow p-0">
          ...
          <div className="grid p-3 gap-3 grow rounded w-full grid-cols-12">
            ...
            <div className="col-span-12 sm:col-span-8 xl:col-span-9 relative order-1 sm:order-1 lg:order-2 relative">
              {<Message show={true} />}
